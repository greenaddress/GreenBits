...
public class WalletClient {
    ...
    public ListenableFuture<PaymentSession> fetchPaymentRequest(final String url) {
        final SettableFuture<PaymentSession> settableFuture = SettableFuture.create();
        return fetchPaymentRequestCall(settableFuture, url);
    }

    private ListenableFuture<PaymentSession> fetchPaymentRequestCall(final SettableFuture<PaymentSession> settableFuture, final String url) {
        ...
        mHttpClientBIP70.newCall(request).enqueue(new Callback() {
            ...
            public void onResponse(Response response) throws IOException {
                try {
                    ...
                    settableFuture.set(new PaymentSession(paymentRequest, true));
    ...
    public ListenableFuture<PaymentProtocol.Ack> sendPayment(final PaymentSession paymentSession,
        ...
        final SettableFuture<PaymentProtocol.Ack> settableFuture = SettableFuture.create();
        return sendPaymentCall(settableFuture, payment, url);
    }

    private ListenableFuture<PaymentProtocol.Ack> sendPaymentCall(final SettableFuture<PaymentProtocol.Ack> settableFuture, final Protos.Payment payment, final URL url) {
        ...
        mHttpClientBIP70.newCall(request).enqueue(new Callback() {
            ...
            public void onResponse(Response response) throws IOException {
                try {
                    ...
                    settableFuture.set(PaymentProtocol.parsePaymentAck(paymentAck));
                } catch (Exception e) {
                    settableFuture.set(null);
                }
            }
